...
- (void)example {
    ...
    // 有个功能是把16进制颜色  转换为10进制存储
    // iOS 存储红色 #FF0000 的得到的10进制是  16711680
    // Android 使用 Color.parseColor("#FF0000") 方法得到的是 -65536
    
    // 红色 #FF0000既可以表示为16711680,也可以表示为-65536
    
    // 为什么不同 原因是有没有把第一位作为符号位
    
    // 例子:
    // 以16进制的0xC000010F为例
    // 既可以表示为 10进制的 3221225743  也可以表示为-1073741553
    // 它的二进制是 1100 0000 0000 0000 0000 0001 0000 1111
    // 规则: 最高位为0表示正数 1表示负数
    // 按照第一位为符号位 这是个负数
    
    // 减一 得到
    // 1100 0000 0000 0000 0000 0001 0000 1110
    // 取反
    // 0011 1111 1111 1111 1111 1110 1111 0001
    // 转成 10 进制
    // 1073741553
    // 加上符号位
    // -1073741553
    ...
    /*大端小端模式的区别
     ...
     高地址
     　　---------------
     　　buf[3] (0x12) -- 高位   buf[3] (0x78) -- 低位
     　　buf[2] (0x34)          buf[2] (0x56)
     　　buf[1] (0x56)          buf[1] (0x34)
     　　buf[0] (0x78) -- 低位   buf[0] (0x12) -- 高位
     　　--------------
     低地址
     
     个人理解
     大小端的模式不影响 高低位的值  但是影响 左边是高位,还是右边是高位的读法
     例如 (大端)1111 0000 或者  (小端)0000 11111   高位都是 1111
